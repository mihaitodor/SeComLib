...
*/
/**
@file private_recommendations_data_packing/privacy_service_provider.cpp
...
namespace PrivateRecommendationsDataPacking {
	...
	*/
	const std::string PrivacyServiceProvider::configurationPath("PrivateRecommendationsDataPacking");
	...
	*/
	PrivacyServiceProvider::PrivacyServiceProvider () {
		...
		this->secureComparisonClient = std::make_shared<SecureComparisonClient>(this->paillierCryptoProvider, this->dgkCryptoProvider);
