...
OUTPUT_FILE=safety_inhomogeneous_poly_part6.out
...
for file in "$TRAINING_FILES_DIR"qolunsafe0246.train "$TRAINING_FILES_DIR"qolunsafe0456.train "$TRAINING_FILES_DIR"qolunsafe01234.train
do
	#default weights
	WEIGHT_ONE=1
	WEIGHT_MINUS_ONE=1
