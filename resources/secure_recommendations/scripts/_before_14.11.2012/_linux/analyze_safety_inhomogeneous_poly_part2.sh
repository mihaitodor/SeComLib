...
OUTPUT_FILE=safety_inhomogeneous_poly_part2.out
...
for file in "$TRAINING_FILES_DIR"qolunsafe3.train "$TRAINING_FILES_DIR"qolunsafe4.train "$TRAINING_FILES_DIR"qolunsafe5.train
do
	#default weights
	WEIGHT_ONE=1
	WEIGHT_MINUS_ONE=1
