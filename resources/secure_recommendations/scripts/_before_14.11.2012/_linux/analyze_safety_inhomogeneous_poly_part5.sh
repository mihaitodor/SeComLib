...
OUTPUT_FILE=safety_inhomogeneous_poly_part5.out
...
for file in "$TRAINING_FILES_DIR"qolunsafe0123.train "$TRAINING_FILES_DIR"qolunsafe0126.train "$TRAINING_FILES_DIR"qolunsafe135.train
do
	#default weights
	WEIGHT_ONE=1
	WEIGHT_MINUS_ONE=1
