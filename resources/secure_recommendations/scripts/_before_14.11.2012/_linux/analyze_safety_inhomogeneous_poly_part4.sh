...
OUTPUT_FILE=safety_inhomogeneous_poly_part4.out
...
for file in "$TRAINING_FILES_DIR"qolunsafe012.train "$TRAINING_FILES_DIR"qolunsafe016.train "$TRAINING_FILES_DIR"qolunsafe056.train
do
	#default weights
	WEIGHT_ONE=1
	WEIGHT_MINUS_ONE=1
