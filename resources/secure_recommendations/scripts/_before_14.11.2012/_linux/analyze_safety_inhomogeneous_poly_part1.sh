...
OUTPUT_FILE=safety_inhomogeneous_poly_part1.out
...
for file in "$TRAINING_FILES_DIR"qolunsafe0.train "$TRAINING_FILES_DIR"qolunsafe1.train "$TRAINING_FILES_DIR"qolunsafe2.train
do
	#default weights
	WEIGHT_ONE=1
	WEIGHT_MINUS_ONE=1
