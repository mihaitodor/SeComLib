...
OUTPUT_FILE=safety_inhomogeneous_poly_part3.out
...
for file in "$TRAINING_FILES_DIR"qolunsafe6.train "$TRAINING_FILES_DIR"qolunsafe01.train "$TRAINING_FILES_DIR"qolunsafe06.train
do
	#default weights
	WEIGHT_ONE=1
	WEIGHT_MINUS_ONE=1
