...
:medical_relevance
	...
	set CInhomogeneousPoly=8
	set GammaRbf=0.000003814697265625
	set CRbf=4194304
	set WeightOne=1
	set WeightMinusOne=1
	...
	set GammaInhomogeneousPoly=0.5
	set CInhomogeneousPoly=8
	set GammaRbf=0.0000002384185791015625
	set CRbf=33554432
	set WeightOne=1
	set WeightMinusOne=1
